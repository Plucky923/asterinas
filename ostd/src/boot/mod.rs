...
pub struct BootInfo {
    ...
    /// The FrameVM runtime symbol table raw bytes.
    pub framevm_symbols: Option<&'static [u8]>,
...
pub(crate) struct EarlyBootInfo {
    ...
    pub(crate) framevm_symbols: Option<&'static [u8]>,
...
pub(crate) fn init_after_heap() {
    ...
    INFO.call_once(|| BootInfo {
        ...
        framevm_symbols: boot_time_info.framevm_symbols,
