...
pub use framev_sock_common::FrameVsockAddr;
...
mod tests {
    ...
    #[ktest]
    fn converts_linux_any_cid_to_carrier_any_cid() {
        let addr = FrameVsockAddr::from(VsockSocketAddr {
            cid: u32::MAX,
            port: 1024,
        });
