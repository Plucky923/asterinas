...
* [VM-based Containers](kernel/vm-based-containers/README.md)
    * [FrameV Protocol: Atomic Interface Stages](kernel/vm-based-containers/framev-design.md)
    * [NVMe Mediated Passthrough: Assignment and I/O Protocol](kernel/vm-based-containers/nvme-passthrough-design.md)
    * [FrameVM Design: CPU, Memory, and I/O Virtualization](kernel/vm-based-containers/framevm-architecture.md)
    * [FrameVM Core Challenges and Mechanisms](kernel/vm-based-containers/framevm-challenges.md)
