...
//! # Zero-Copy Design
//!
//! - Incoming data packets are stored as RRef<FrameVsockPacket> in a queue
...
//! - Outgoing data is read directly from user buffer into FrameVsockPacket
//!
...
use framev_sock_common::{ConnectionId, FrameVsockPacket, flow_control::DEFAULT_BUF_ALLOC};
...
struct RxState {
    ...
    pending_packets: VecDeque<RRef<FrameVsockPacket>>,
