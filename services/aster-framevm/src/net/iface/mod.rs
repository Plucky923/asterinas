...
//! FrameVM Ethernet interface wiring over the bound FrameV-net device.
...
pub use init::{framev_iface, init, iter_all_ifaces, loopback_iface};
pub(super) use poll::{init_in_first_kthread, shutdown};
