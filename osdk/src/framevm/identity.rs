...
const FRAMEVM_SOURCE_HASH_ROOTS: &[&str] = &[
    ...
    "test/initramfs/nix/framevmm.nix",
...
mod tests {
    ...
    #[test]
    fn framevm_source_hash_covers_service_object_inputs() {
        for service_input in SERVICE_OBJECT_INPUT_ROOTS {
            assert!(
                FRAMEVM_SOURCE_HASH_ROOTS.contains(service_input),
