...
/// Clears service-local block registrations before a new FrameVM component profile starts.
pub fn clear_for_framevm_component_profile() {
...
/// Initializes the block component in the FrameVM component profile.
pub fn init_for_framevm_component_profile() -> Result<(), ComponentInitError> {
    clear_for_framevm_component_profile();
    device_id::init();
...
fn init_in_first_process() -> Result<(), ComponentInitError> {
    init_process_for_framevm_component_profile()
}

/// Initializes block partitions in the FrameVM component profile.
pub fn init_process_for_framevm_component_profile() -> Result<(), ComponentInitError> {
