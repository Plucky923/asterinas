...
int main(int argc, char *argv[]) {
    ...
    printf("[Host Receiver] Starting on port %d (AF_FRAMEVSOCK)...\n", port);
    ...
    printf("[Host Receiver] Listening...\n");
    ...
    while (1) {
        ...
        printf("[Host Receiver] Connection from CID %u, port %u\n",
        ...
        printf("[Host Receiver] Done. Received %llu bytes in %.2f sec = %.2f MB/s\n",
               total_bytes, duration, mbs);
