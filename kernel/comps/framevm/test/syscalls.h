...
static inline long sys_clone(unsigned long flags, void *child_stack, void *ptid, void *ctid, unsigned long tls) {
    return syscall6(SYS_CLONE, flags, (long)child_stack, (long)ptid, (long)ctid, (long)tls, 0);
}
...
static inline int sys_wait4(int pid, int *status, int options, void *rusage) {
