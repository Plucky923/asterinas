...
//! Implements the restricted FrameVM `/proc` filesystem.
//!
//! Static entries are assembled from reusable directory/file templates, while process entries
//! are created dynamically and expose only the subset required by the service environment.
