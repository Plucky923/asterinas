...
class Verifier:
    ...
    def verify_source_structure(self) -> None:
        ...
        framevm_device_rs = read_text(self.root / "kernel" / "src" / "device" / "misc" / "framevm" / "mod.rs")
        ...
        self.check("framevm.symbols" not in framevm_device_rs, "FrameVM device parses or references framevm.symbols")
